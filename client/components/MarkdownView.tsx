...
export default function MarkdownViewer({
	...
	return (
		<article className="dark:bg-gray-900/80 flex-1 min-w-0 dark:prose-invert px-2 whitespace-normal break-all markdown-body bg-gray-200 relative">
			...
			<div
				onClick={handleCopy}
				className="text-white opacity-20 hover:opacity-100 flex items-center gap-1 bg-gray-500/20 hover:bg-gray-500/80 px-2 rounded-md absolute top-1 right-0 cursor-pointer"
			>
